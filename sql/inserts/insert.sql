...
-- ('Kevin Alpizar', 'kevin@gmail.com', 'cliente'),
-- ('Maria Matarrita', 'Maria@gmail.com', 'cliente');
...
-- INSERT INTO usuarios (nombre, email, tipo) VALUES ('Kevin Alpizar', 'kevin@gmail.com', 'cliente');
...
-- INSERT INTO habitaciones (hotel_id, numero, tipo, precio) VALUES (1, '01', 'individual', 75.00);

-- INSERT INTO reservas (usuario_id, habitacion_id, fecha_inicio, fecha_fin)
-- VALUES (1, 1, '2024-07-01', '2024-07-05');